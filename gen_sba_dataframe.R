...
plotSBAData <- function(aMinEnrollment = 100, aGrade=8) {
  ...
  for (i in 1:length(sba_dem_districts)) {
    ...
    chartScatter(
      ...
      aTitle = paste(
        "WA Public Schools with Grade ",aGrade," with ", aMinEnrollment,"+ Students \n 2015 SBA Results (",
      ...
      aYLabel = paste("% of Students in Grade ",aGrade," Who Met Standard in Math",sep = ""),
      ...
      aSavePlotFilename = paste(
        "ReportsAutoGenerated//SBA Math Grade ",aGrade," ",district," Schools 2015.png",sep = ""
      ),aSavePlot = T
    )
  }
}
